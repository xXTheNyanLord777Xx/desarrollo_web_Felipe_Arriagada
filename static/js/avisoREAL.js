...
const ValidatePhone = (phone) => {
  ...
  let lengthValid = phone.length >= 8;//mayor a 8
  let re = /^\+\d{3}\.\d{8,}$/; //formato +NNN.NNNNNNNN
...
const ValidateTipo = (tipoValue) => tipoValue !== "";

const ValidateUnidad = (unidadValue) => unidadValue !== "";
